<template lang='pug'>
v-layout.input-output(fill-height column)
    .main-pane.white.elevation-3
        h1.exp-top 解説ページ
        br
        .unit-title
            v-chip(color='#CE93D8' text-color='#7B1FA2' selected outline) 　　入出力　　
        ...
        v-divider
        .prev-next-btn
            v-btn(v-scroll-to='"body"' :to='{ name: "operate-exp"}' color='primary' flat) << prev. 演算
            v-btn(v-scroll-to='"body"' :to='{ name: "condition-exp"}' color='primary' flat) next. 条件分岐 >>
...
@Component
export default class InputOutput extends Vue {}
</script>
