<template lang='pug'>
v-layout.condition(fill-height column)
    .main-pane.white.elevation3
        h1.exp-top 解説ページ
        br
        .unit-title
            v-chip(color='#CE93D8' text-color='#7B1FA2' selected outline) 　　条件分岐　　
        ...
        v-divider
        .prev-next-btn
            v-btn(v-scroll-to='"body"' :to='{ name: "io-exp"}' color='primary' flat) << prev. 入出力
            v-btn(v-scroll-to='"body"' :to='{ name: "loop-exp"}' color='primary' flat) next. 繰り返し >>
</template>
